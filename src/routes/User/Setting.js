...
export default class Setting extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.setting.status === 'ok') {
      this.props.dispatch(routerRedux.push('/user/settingResult'));
    }
  }
      ...
      <div className={styles.main}>
        ...
        <Form onSubmit={this.handleSubmit} >
            ...
            >
              {getFieldDecorator('password', {
                ...
                <Input
                  size="large"
                  type="password"
                  placeholder="请输入新密码，至少6位密码，区分大小写"
                />
              )}
            </Popover>
          </FormItem>
          ...
          <FormItem>
            <Row gutter={8}>
              <Col span={18}>
                <Button size="large" className={styles.submit} type="primary" htmlType="submit"> 提交</Button>
              </Col>
              <Col span={6}>
